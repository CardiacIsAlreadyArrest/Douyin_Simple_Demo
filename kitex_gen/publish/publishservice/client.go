...
type Client interface {
	...
	GetVideoList(ctx context.Context, req *publish.GetVideoListRequest, callOptions ...callopt.Option) (r *publish.GetVideoListResponse, err error)
}
...
func (p *kPublishServiceClient) GetVideoList(ctx context.Context, req *publish.GetVideoListRequest, callOptions ...callopt.Option) (r *publish.GetVideoListResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
